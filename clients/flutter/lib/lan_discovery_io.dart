/// UDP multicast LAN discovery (ADR-0016). Native-only - browsers have no
/// raw socket API. Selected for non-web targets by the conditional export
/// in `lan_discovery.dart`.
library;
