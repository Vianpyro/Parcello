...
/// (settings / leave / resign / room code), Objectives (the win condition and
/// VP scoring), and History (the event feed). No graphical placeholders: every
/// button does something real, reusing the existing widgets.
///
    ...
    return Container(
      ...
      child: FocusTraversalGroup(
        child: Column(children: [
          _RailButton(
              icon: Icons.menu, label: t.navMenu, onTap: () => _menu(context)),
  ...
  void _menu(BuildContext context) {
    ...
    _sheet(
      ...
      Column(mainAxisSize: MainAxisSize.min, children: [
        if (s.code != null)
          Row(children: [
            Expanded(child: Text(t.sideRoom(s.code!), style: PcText.rowTitle)),
            IconButton(
  ...
  void _objectives(BuildContext context) {
    ...
    _sheet(
      ...
      Column(
        ...
        children: [
          Text(target > 0 ? t.vpLegendHeader(target) : t.navObjectives,
...
class _RailButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return hoverSfx(TextButton(
      onPressed: onTap,
      style: TextButton.styleFrom(
        foregroundColor: Pc.textMuted,
        padding: const EdgeInsets.symmetric(vertical: Pc.s6, horizontal: Pc.s2),
